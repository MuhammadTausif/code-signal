var exercies = document.getElementsByClassName("-layout-h -center -padding-4 -space-h-16")
for (let i = 0; i < exercies.length; i++) {
    console.log(exercies[i].firstChild.innerText)
}

const exercises_list = []
for (let i = 0; i < exercies.length; i++) {
    console.log(exercies[i].firstChild.innerText + "- " + exercies[i].children[1].innerText)
    exercises_list.push(exercies[i].firstChild.innerText + "- " + exercies[i].children[1].innerText)
}

copy(exercises_list)

var lists = document.getElementsByClassName("block arcade-map--topic-title -bg-white -layout-h -align-center -padding-8")
const tn = []
for (let index = 0; index < lists.length; index++) {
    console.log(index + ". "+lists[index].firstChild.innerText)
    tn.push(index + ". "+lists[index].firstChild.innerText)
}
const chap_names = [
    "Intro Gates",
    "At the Crossroads",
...
var chapters = [
    "0. Intro Gates",
    "1. At the Crossroads",
    "2. Corner of 0s and 1s",
    "3. Loop Tunnel",
    "4. List Forest Edge",
    "5. Labyrinth of Nested Loops",
    "6. Book Market",
    "7. Mirror Lake",
    "8. Well of Integration",
    "9. Lab of Transformations",
    "10. Spring of Integration",
    "11. List Backwoods",
    "12. Waterfall of Integration",
    "13. Sorting Outpost",
    "14. Chess Tavern",
    "15. Time River",
    "16. Regular Hell",
